...
ResultMapPath = 'D:/#Projects/Multiple Projects Prof. Ram Sarkar/Segmentation (Hritam Da)/ISIC2017/';
Models = {'Skin'}; %Models = {'UNet','UNet++','SFA'}; 
modelNum = length(Models);

% ---- 2. Ground-truth Datasets Setting ----
DataPath = ResultMapPath;
Datasets = {'Skin'}; %Datasets = {'CVC-ClinicDB', 'CVC-ColonDB','ETIS-LaribPolypDB', 'Kvasir','CVC-300'}; 
...
for d = 1:datasetNum
    ...
    for m = 1:modelNum
        ...
        resMapPath = [ResultMapPath model '/Output/' ];
